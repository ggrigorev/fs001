...
<pin>
  <simplex>
    ...
    <loc presence="REQUIRED" value="CDATA" />
    ...
    <iobank.internal_vref presence="IMPLIED" value="CDATA" />
    <iobank.dci_cascade presence="IMPLIED" value="CDATA" />
    <pcb_min_delay presence="IMPLIED" value="CDATA" />
    <pcb_max_delay presence="IMPLIED" value="CDATA" />
  </simplex>
</pin>
    ...
    String:pull_type
    String:voh
    String:iobank__DOT__internal_vref
    String:iobank__DOT__dci_cascade
    String:pcb_min_delay
    String:pcb_max_delay
...
public String iobank__DOT__internal_vref = null;
public String iobank__DOT__dci_cascade = null;
public String pcb_min_delay = null;
public String pcb_max_delay = null;
